...
<div class="widget">
	...
	<div class="widget-articles">
		<center>
			<?php
			$kepalasekolah = $this->model_app->view_where('users',array('username'=>'kepala'))->row_array();
			echo "<img style='border:3px solid #fff' width='170px' src='".base_url()."asset/foto_user/$kepalasekolah[foto]'>
			<p><b>Kepala Sekolah</b><br> $kepalasekolah[nama_lengkap] <br>";
